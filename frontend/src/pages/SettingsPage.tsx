      ...
      case 'preferences':
        return (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="p-6 rounded-2xl bg-background border border-border space-y-6 max-w-md">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="p-2 bg-card rounded-xl text-text-secondary group-hover:text-amber-500 transition-colors">
                    {isDark ? <Moon size={20} /> : <Sun size={20} className="text-amber-500" />}
                  </div>
                  <div>
                    <p className="font-semibold text-text-primary">Dark Mode</p>
                    <p className="text-xs text-text-secondary">Passa al tema scuro o chiaro</p>
                  </div>
                </div>
                <div 
                  onClick={toggleTheme}
              ...
              <button className="w-full py-3 bg-accent text-white font-bold rounded-xl shadow-lg hover:bg-accent/90 transition-all">Save Global Preferences</button>
            </div>
          </div>
        );
      case 'activities':
