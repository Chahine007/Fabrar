...
export const CAPABILITIES = Object.freeze({
  ...
  CRM_ACCOUNTS_READ: "crm:accounts:read",
  CRM_ACCOUNTS_WRITE: "crm:accounts:write",
  CRM_ACCOUNTS_EXPORT: "crm:accounts:export",
  ...
  CRM_DEALS_EXPORT: "crm:deals:export",
  CRM_TICKETS_READ: "crm:tickets:read",
  CRM_TICKETS_WRITE: "crm:tickets:write",
  CRM_TICKETS_EXPORT: "crm:tickets:export",
  CRM_CAMPAIGNS_READ: "crm:campaigns:read",
  CRM_CAMPAIGNS_WRITE: "crm:campaigns:write",
  CRM_CAMPAIGNS_EXPORT: "crm:campaigns:export",
  CRM_ADMIN: "crm:admin",
});
...
const ROLE_CAPABILITIES = Object.freeze({
  [AppRole.ADMIN]: [
    ...
    // Additional admin capabilities required for new features
  ...
  [AppRole.HR]: [
    ...
    CAPABILITIES.CRM_ACCOUNTS_READ,
    CAPABILITIES.CRM_ACCOUNTS_WRITE,
    CAPABILITIES.CRM_CONTACTS_READ,
    CAPABILITIES.CRM_CONTACTS_WRITE,
    CAPABILITIES.CRM_DEALS_READ,
    CAPABILITIES.CRM_DEALS_WRITE,
    CAPABILITIES.CRM_TICKETS_READ,
    CAPABILITIES.CRM_TICKETS_WRITE,
    CAPABILITIES.CRM_CAMPAIGNS_READ,
    CAPABILITIES.CRM_CAMPAIGNS_WRITE,
  ],
